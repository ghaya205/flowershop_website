    ...
    <div class ="box-container">
      ...
      <div class="box">
        ...
        <div class="box">
          ...
          <div class="box">
          <?php
          $select_totaluser = mysqli_query($conn, "SELECT * FROM `users` WHERE user_type = 'user'") or die('query failed');
          $num_of_totaluser = mysqli_num_rows($select_totaluser);
          ?>
          <h3><?php
          echo $num_of_totaluser;
          ?></h3>
          <p> total users </p>
        </div>
        <div class="box">
